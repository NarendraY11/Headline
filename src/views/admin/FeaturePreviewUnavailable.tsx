...
function FeaturePreviewUnavailableInner({
  ...
  return (
    <div
      role="status"
      aria-label={feature ? `${feature.title} preview is unavailable` : "Preview unavailable"}
      className="h-full min-h-[220px] rounded-xl border border-dashed border-rule-strong bg-bg-2/60 p-6 flex flex-col items-center justify-center text-center"
    >
      <EyeOff size={24} className="text-muted-2 mb-3" aria-hidden="true" />
