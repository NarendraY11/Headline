  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="text-muted hover:text-ink transition-colors p-1 -mt-1 -mr-1 rounded shrink-0 focus-visible:ring-2 focus-visible:ring-sky/60 focus-visible:outline-none"
      >
        <X size={16} />
      </button>
    </div>
